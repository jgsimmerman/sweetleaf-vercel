...
const Privacy = center => (
  <Layout>
    ...
    from sweetleafsucculents.com (the “Site”).
    </p>
    ...
    information about the individual web pages or products that you view, what websites or search terms referred you to the Site, 
    ...
    <p>
      ...
      <ul>
        ...
        <li> “Log files” track actions occurring on the Site, and collect data including your IP address, browser type, Internet service provider, 
    ...
    <p>
      ...
      contact us by e-mail at sweetleafsucculents@gmail.com or by mail using the details provided below:
    </p>
